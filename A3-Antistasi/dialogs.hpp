...
class first_load 		{
	...
	class controls {
		...
		class HQ_button_Gstatic: RscButton
		{
			...
			action = "closeDialog 0;if ((true) and (isNil ""placementDone"") and !(isMultiplayer)) then {_nul = [] spawn placementselection};";
		};
		/*
...
class HQ_menu 			{
	...
	class controls {
		...
		class HQ_button_load: RscButton
		{
			...
			action = "if (isMultiPlayer) then {if (true) then {nul=call theBossSteal} else {hint ""Only Player Commander has access to this function""}} else {hint ""This function is MP only""};";
		};
		class HQ_button_savegame: RscButton
		{
			...
			action = "closeDialog 0;if (true) then {nul=CreateDialog ""build_menu""} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_moveHQ: RscButton
		{
			...
			action = "closeDialog 0;if (true) then {nul = [] spawn moveHQ;} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_recruitUnit: RscButton
		{
			...
			action = "if (true) then {if (isMultiplayer) then {nul = [] call membersList} else {hint ""This function is MP only""}} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_recruitSquad: RscButton
		{
			...
			h = 0.0560125 * safezoneH;
			tooltip = "Cost: 5.000 €";
			action = "closeDialog 0;if (true) then {nul=[] spawn rebuildAssets} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_vehicle: RscButton
		{
			...
			h = 0.0560125 * safezoneH;
			tooltip = "";
			action = "closeDialog 0;if (true) then {nul = [] call FIAskillAdd} else {hint ""Only Player Commander has access to this function""};";
		};
...
class game_options 		{
	...
	class controls {
		...
		class 8slots_L1: RscButton
		{
			...
			action = "if (true) then {closeDialog 0; nul = createDialog ""civ_config""} else {hint ""Only Player Commander has access to this function""};";
		};
		class 8slots_R1: RscButton
		{
			...
			action = "if (true) then {closeDialog 0; nul = createDialog ""spawn_config""} else {hint ""Only Player Commander has access to this function""};";
		};
		class 8slots_L2: RscButton
		{
			...
			action = "if (true) then {closeDialog 0; nul = createDialog ""fps_limiter""} else {hint ""Only Player Commander has access to this function""};";
		};
		...
		*/
		class 8slots_M4: RscButton
		{
			...
			action = "closeDialog 0;if (true) then {[""statSave\saveLoop.sqf"",""BIS_fnc_execVM""] call BIS_fnc_MP} else {_nul = [] execVM ""statSave\saveLoop.sqf""; hintC ""Personal Stats Saved""};";
		};
	};
};										//slots 6+1
class fps_limiter 			{
	...
	class controls {
		...
		class HQ_button_Gsquad: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "if (true) then {if (maxUnits < 200) then {maxUnits = maxUnits + 10; publicVariable ""maxUnits""; hint format [""AI Limit has been set at %1"",maxUnits]} else {hint ""AI Limit cannot be raised from 200""}} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_Gstatic: RscButton
		{
			idc = -1;
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "if (true) then {if (maxUnits > 80) then {maxUnits = maxUnits - 10; publicVariable ""maxUnits""; hint format [""AI Limit has been set at %1"",maxUnits]} else {hint ""AI Limit cannot be less than 80""}} else {hint ""Only Player Commander has access to this function""};";
		};
	};
};
class spawn_config 			{
	...
	class controls {
		...
		class HQ_button_Gsquad: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "if (true) then {if (distanciaSPWN < 2000) then {distanciaSPWN = distanciaSPWN + 100; distanciaSPWN1 = distanciaSPwN * 1.3; distanciaSPWN2 = distanciaSPWN /2; publicVariable ""distanciaSPWN"";publicVariable ""distanciaSPWN1"";publicVariable ""distanciaSPWN2""}; hint format [""Spawn Distance Set to %1 meters. Be careful, this may affect game performance"",distanciaSPWN]} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_Gstatic: RscButton
		{
			idc = -1;
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "if (true) then {if (distanciaSPWN > 600) then {distanciaSPWN = distanciaSPWN - 100; if (distanciaSPWN < 600) then {distanciaSPWN = 600}; distanciaSPWN1 = distanciaSPwN * 1.3; distanciaSPWN2 = distanciaSPWN /2; if (distanciaSPWN < 600) then {distanciaSPWN = 600};publicVariable ""distanciaSPWN"";publicVariable ""distanciaSPWN1"";publicVariable ""distanciaSPWN2"";}; hint format [""Spawn Distance Set to %1 meters"",distanciaSPWN]} else {hint ""Only Player Commander has access to this function""};";
		};
	};
};
class civ_config 			{
	...
	class controls {
		...
		class HQ_button_Gsquad: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "if (true) then {if (civPerc < 150) then {civPerc = civPerc + 1; if (civPerc > 150) then {civPerc = 150}; publicVariable ""civPerc"";}; hint format [""Maximum Number of Civilians Set to %1"",civPerc]} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_Gstatic: RscButton
		{
			idc = -1;
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "if (true) then {if (civPerc > 0) then {civPerc = civPerc - 1; if (civPerc < 0) then {civPerc = 0};publicVariable ""civPerc"";}; hint format [""Maximum Number of Civilians Set to %1"",civPerc]} else {hint ""Only Player Commander has access to this function""};";
		};
	};
};
...
class mission_menu 		{
	...
	class controls {
		...
		class HQ_button_AS: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "closeDialog 0;if ((true) or (not(isPlayer theBoss))) then {[[""AS""],""missionrequest""] call BIS_fnc_MP} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_CONV: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "closeDialog 0;if ((true) or (not(isPlayer theBoss))) then {[[""CONVOY""],""missionrequest""] call BIS_fnc_MP} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_DES: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "closeDialog 0;if ((true) or (not(isPlayer theBoss))) then {[[""DES""],""missionrequest""] call BIS_fnc_MP} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_LOG: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "closeDialog 0;if ((true) or (not(isPlayer theBoss))) then {[[""LOG""],""missionrequest""] call BIS_fnc_MP} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_RES: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "closeDialog 0;if ((true) or (not(isPlayer theBoss))) then {[[""RES""],""missionrequest""] call BIS_fnc_MP} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_vehicle: RscButton
		{
			idc = -1;
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "closeDialog 0;if ((true) or (not(isPlayer theBoss))) then {[[""CON""],""missionrequest""] call BIS_fnc_MP} else {hint ""Only Player Commander has access to this function""};";
		};
...
class radio_comm 		{
	...
	class controls {
		...
		class 8slots_L3: RscButton
		{
			...
			action = "closeDialog 0;if (false) then {nul = [false] call garageVehicle} else {if (isMultiplayer) then {_nul = createDialog ""garage_check""} else {nul = [true] call garageVehicle}};";
		};
		class 8slots_R3: RscButton
		{
			idc = -1;
...
class vehicle_manager 		{
	...
	class controls {
		...
		class HQ_button_Gstatic: RscButton
		{
			...
			action = "closeDialog 0; if (true) then {nul = createDialog ""squad_manager""} else {hint ""Only Player Commander has access to this function""};";
		};
...
class veh_query 				{
	...
	class controls {
		...
		class HQ_button_back: RscButton
		{
			...
			w = 0.06 * safezoneW;//0.175015
			h = 0.05 * safezoneH;
			action = "closeDialog 0;vehQuery = nil; if (true) then {nul= [] execVM ""Dialogs\squad_recruit.sqf""} else {hint ""Only Player Commander has access to this function""};";
		};
		class HQ_button_Gsquad: RscButton
		{
			idc = 104;
...
class commander_comm 		{
	...
	class controls {
		...
		class 8slots_L1: RscButton
		{
			...
			action = "closeDialog 0;if (true) then {nul= [] execVM ""Dialogs\squad_recruit.sqf""} else {hint ""Only Player Commander has access to this function""};";
		};
		class 8slots_R1: RscButton
		{
			idc = -1;
			...
			action = "closeDialog 0;if (true) then {_nul = createDialog ""carpet_bombing""} else {hint ""Only Player Commander has access to this function""};";
		};
		class 8slots_L2: RscButton
		{
			idc = -1;
			...
			h = 0.0560125 * safezoneH;
			tooltip = "Establish a new watchpost or roadblock depending on the type of terrain you select";
			action = "if (true) then {closeDialog 0;[""create""] spawn puestoDialog} else {hint ""You're not the Commander!""};";
		};
		class 8slots_R2: RscButton
		{
			idc = -1;
			...
			action = "if (true) then {closedialog 0;[] remoteExec [""garbageCleaner"",2]} else {hint ""Only Player Commander has access to this function""};";
		};
		class 8slots_L3: RscButton
		{
			idc = -1;
			...
			action = "if (true) then {closeDialog 0; [""delete""] spawn puestoDialog} else {hint ""You're not the Commander!""};";
		};
		class 8slots_R3: RscButton
		{
			idc = -1;
			...
			action = "if (true) then {closeDialog 0;nul = [true] call garageVehicle;} else {hint ""You're not the Commander!""};";
		};
		class 8slots_L4: RscButton
		{
			idc = -1;
		...
		class 8slots_R4: RscButton
		{
			...
			action = "if (true) then {closeDialog 0; nul = [] call sellVehicle} else {hint ""Only the Commander can sell vehicles""};";
		};
	};
};
...
class garage_sell 			{
	...
	class controls {
		...
		class HQ_button_Gstatic: RscButton
		{
			...
			w = 0.175015 * safezoneW;
			h = 0.0560125 * safezoneH;
			action = "closeDialog 0; if (true) then {nul = [] call sellVehicle} else {hint ""Only the Commander can sell vehicles""};";
		};
		/*
		class HQ_button_Gremove: RscButton
		{
